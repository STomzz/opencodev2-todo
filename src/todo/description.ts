/** V1's `todowrite` tool description, ported verbatim from `todowrite.txt`. */
export const TODO_DESCRIPTION = `Create and maintain a structured task list for the current coding session. Tracks progress, organizes multi-step work, and surfaces status to the user.
